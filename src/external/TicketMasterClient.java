...
public class TicketMasterClient {
	...
	private static final String API_KEY = "GtAfU2vceyxGMchVTDVsle5UHEIvMR27";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			if (!obj.isNull("_embedded")) {
				...
				//return getItemList(embedded.getJSONArray("event"));
	...
	// one event might belong to more categories
	...
	public static void main(String[] args) {
		...
		List<Item> events = client.search(37.28,  -122.08,  null);
