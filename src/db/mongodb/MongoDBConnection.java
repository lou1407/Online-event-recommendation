...
public class MongoDBConnection implements DBConnection{
	...
	public Set<Item> getFavoriteItems(String userId) {
		...
		for (String itemId : favoriteItemIds) {
			...
			if (iterable.first() != null) {
				...
				builder1.setItemId(doc.getString("item_id"));
				builder1.setName(doc.getString("name"));
				builder1.setAddress(doc.getString("address"));
				builder1.setUrl(doc.getString("url"));
				builder1.setImageUrl(doc.getString("image_url"));
				builder1.setRating(doc.getDouble("rating"));
				builder1.setDistance(doc.getDouble("distance"));
				builder1.setCategories(getCategories(itemId));
				favoriteItems.add(builder1.build());
	...
	public void saveItem(Item item) {
		...
		FindIterable<Document> iterable = db.getCollection("items").find(eq("item_id", item.getItemId())); // or new Document("item_id);
		if (iterable.first() == null) {
